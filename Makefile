...
help: ## Shows this message.
	@echo "Asynchronous Python client for Sonoff DIY devices."; \
	echo; \
	echo "Usage:"; \
	awk -F ':|##' '/^[^\t].+?:.*?##/ {\
...
lint-black: ## Run linting using black & blacken-docs.
	black --safe --target-version py36 sonoffdiy tests examples; \
...
test: ## Run tests quickly with the default Python.
	pytest --cov-report html --cov-report term --cov=sonoffdiy .;
